...
// ===== LOGIN INDOPAKET =====
const INDOPAKET_LOGIN_URL = 'https://www.indopaket.co.id/login'; // ganti sesuai website asli
const INDOPAKET_FORM_URL = 'https://www.indopaket.co.id/create-shipment'; // ganti sesuai website asli
...
async function kirimPaket() {
    ...
    try {
        ...
        try {
            ...
            status = 'Paket dikirim, tapi tidak bisa membaca konfirmasi.';
        }
...
bot.on('message', async msg => {
    ...
    // Menu Titip Paket → jalankan Puppeteer
    if (text === "📦 Titip Paket") {
        bot.sendMessage(msg.chat.id, "Sedang memproses paket otomatis...");
